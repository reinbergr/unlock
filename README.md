...
<b>Использование:</b> перейдите в приложение → выберите стратегию → настройте мобильные устройства<br>
<b>NOTE:</b> убедитесь что все ваши устройства находятся в одной WIFI-сети а в браузере включите secure-DNS<br>
