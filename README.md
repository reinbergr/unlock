...
- [x] <b>Выбор стратегии обхода DPI.</b> При выборе стратегии запустится <b>winws.exe</b> для модифицикации исходящих сетевых пакетов (через WinDivert/Windows) чтобы обмануть DPI/ТСПУ-фильтры провайдера.
